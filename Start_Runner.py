...
class ScriptRunner:
    ...
    def __init__(self, obj):
        self.root = obj
        self.root.title("Gayltix Script Runnner")
        ...
        self.stop_button = Button(self.button_frame, text = "Stop", bg = "red", command =lambda:self.stop_execution() , height=2, width=12, padx = 5, pady = 5)
        ...
        self.scrolled_text.tag_config("FAILURE", foreground ="Red")
    ...
    def start_execution(self):
        ...
        while True:
            ...
            if output:
                ...
                if "DEBUG" in str(output.strip()):
                    self.scrolled_text.insert(END, output.strip(), "DEBUG")
                elif "Running IT" in str(output.strip()):
                    self.scrolled_text.insert(END, output.strip(), "RUNNINGIT")
                elif "Running test:" in str(output.strip()):
    ...
    def stop_execution(self):
        ...
        self.scrolled_text.insert(END, "Execution Terminated", "STOP")
        self.scrolled_text.insert(END, "\n", "DEBUG")
